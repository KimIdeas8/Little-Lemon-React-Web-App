...
function Footer(props) {
    ...
    return(
        <footer>
            <section>
                <img src={process.env.PUBLIC_URL + '/images/footer_img.png'} alt="logo" ></img>
            </section>
            <section>
            ...
            <section>
                ...
                <div className="socials-list">
                    <a aria-label="Instagram Link" href="https://www.instagram.com/"><img className="socials-list insta" src={process.env.PUBLIC_URL+'/images/instagram.svg'} alt="ig icon"/></a>
                    <a aria-label="Facebook Link" href="https://www.facebook.com/"><img className="socials-list fb" src={process.env.PUBLIC_URL+'/images/facebook.svg'} alt="fb icon"/></a>
                    <a aria-label="Twitter Link" href="https://twitter.com/?lang=en"><img className="socials-list twitter" src={process.env.PUBLIC_URL+'/images/twitter.svg'} alt="t icon"/></a>
                </div>
            </section>
        </footer>
    )
